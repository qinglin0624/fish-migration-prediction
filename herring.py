...
def tem_cond(t):    
    ...
    f=(1/(2.5*np.sqrt(2*np.pi)))*np.exp(-np.square(t-5)/(2*2.5*2.5))    
...
if __name__== '__main__':
    ...
    populate((51,115),(63,123))
    populate((59,96),(67,108))
    ...
    while year<=50:
        ...
        year=year+1
        oval1 = canvas.create_oval(530,300,570,340,outline='#FFF68F',width=1.5)
        oval2 = canvas.create_oval(530,325,570,365,outline='#FFF68F',width=1.5)
        oval3 = canvas.create_oval(500,260,660,420,outline='#FFF68F',width=1.5)
